...
export default function ReactCounter() {
  ...
  const [fc, setRef] = useCanvas(async (canvas) => {
    ...
    const position = new fabric.IText('Freelance Content writing', {
      ...heroTextOptions,
    ...
    const colDescriptionTextOptions = {
      lockScalingFlip: true,
      lockScalingY: true,
      lockUniScaling: true,
      lockMovementX: true,
...
Interest in food`,
    ...
    fabric.IText.prototype['_renderBackground'] = _renderBackground
    ...
    const website = new fabric.IText('dgtal.id', { ...footerTextOptions, left: 99.2 + 28 })
